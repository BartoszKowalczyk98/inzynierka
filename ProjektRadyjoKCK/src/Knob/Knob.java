...
public class Knob extends Control{
    ...
    public final DoubleProperty maxValueProperty(){
        if(null == maxValue){
            maxValue=new SimpleDoubleProperty(Knob.this,"maxValue",_maxValue);
        }
        return maxValue;
    }
    ...
    public DoubleProperty minValueProperty(){
        if(null == minValue){
            minValue=new SimpleDoubleProperty(Knob.this,"minValue",_minValue);
        }
        return minValue;
    }
    ...
    private static class StyleableProperties {
        ...
        private static final DefaultPropertyBasedCssMetaData<Knob, Paint> MARKER_COLOR = CssHelper.createMetaData("-fx-knob-marker-color", PaintConverter.getInstance(), "markerColor",Color.RED);
        ...
        private static final DefaultPropertyBasedCssMetaData<Knob, Paint> KNOB_STROKE = CssHelper.createMetaData("-fx-knob-stroke", PaintConverter.getInstance(), "knobStroke",Color.RED);
